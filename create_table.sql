...
DROP TABLE IF EXISTS public.patient_permissions_module_zgody;
DROP TABLE IF EXISTS public.patient_permissions_module_pacjenci;
DROP TABLE IF EXISTS public.campaign_notifications;
DROP TABLE IF EXISTS public.campaigns;
DROP TABLE IF EXISTS public.appointment_notifications;
DROP TABLE IF EXISTS public.appointments;
DROP TABLE IF EXISTS public.unaccepted_examinations;
DROP TABLE IF EXISTS public.examinations;
DROP TABLE IF EXISTS public.patients_old;
...
DROP TABLE IF EXISTS public.d_country;
DROP TABLE IF EXISTS public.d_region;
DROP TABLE IF EXISTS public.d_staff_title;
DROP TABLE IF EXISTS public.d_staff_role;
DROP TABLE IF EXISTS public.d_gender;
DROP TABLE IF EXISTS public.d_appointment_type;
DROP TABLE IF EXISTS public.d_address_prefix;
